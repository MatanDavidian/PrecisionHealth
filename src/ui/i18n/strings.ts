...
const en = {
  ...
  'nutrition.totalOn': 'Total for {day}',
  'nutrition.logAMeal': 'Log a meal',
  'describe.label': 'What did you eat?',
  'describe.placeholder': 'a bowl of pasta with tomato sauce and parmesan',
  'describe.estimate': 'Estimate from your words',
  'describe.estimating': 'Estimating…',
  'describe.addTo': 'Add to {day}',
  'nutrition.addMeal': 'Add meal',
  'nutrition.addMealTo': 'Add meal to {day}',
  'repeat.mode': 'Again',
  'repeat.nothingYet': 'Nothing to repeat yet — log a few meals and they will show up here.',
  'repeat.seenBefore': 'Logged {count}× · usually {slot}',
  'repeat.unconfirmed': 'numbers not yet confirmed',
  'repeat.addsTo': 'Adds a copy to {day}. Editing it later leaves the original alone.',
  'nutrition.modeManual': 'Manual',
  'nutrition.modeDescribe': 'Describe',
  ...
  'estimate.kcalShort': 'kcal',
  'estimate.protShort': 'Prot',
  'estimate.carbShort': 'Carb',
  'estimate.fatShort': 'Fat',
  'editor.refilledBy': 'Refilled {taps}× · +{percent}%',
  'editor.saveWithTotal': 'Save · {kcal}',
  'leftover.prompt': 'Something on the plate left over?',
  'leftover.saveFirst': 'Save or undo your changes first — a leftover is measured against the meal as recorded.',
  'leftover.open': 'Log leftover',
  'leftover.openTitle': 'Leftover — scale this meal down for what was not eaten',
  'leftover.whatsLeft': "What's left of the whole meal?",
  'leftover.photoPrompt': "Photo of what's left on the plate",
  'leftover.describePrompt': 'all the egg eaten but only half of the bread',
  'leftover.estimate': 'Estimate leftover',
  'leftover.share': 'About {percent}% of this meal was eaten',
  'leftover.willScale':
    'Each food scales to the share that was eaten — stored as new numbers, not a note. They come from the model, so they need confirming.',
  'leftover.nothingLeft': 'Nothing came back — this meal is unchanged.',
  'leftover.apply': 'Apply to this meal',
  'leftover.again': 'Try again',
  ...
  'gaps.estimatedDayNote':
    'Nothing was logged, so these are your average day. Log a meal here and it replaces the estimate.',
...
const he: Dictionary = {
  ...
  'nutrition.totalOn': 'הסך הכל ל{day}',
  'nutrition.logAMeal': 'רישום ארוחה',
  'describe.label': 'מה אכלתם?',
  'describe.placeholder': 'קערת פסטה ברוטב עגבניות ופרמזן',
  'describe.estimate': 'הערכה מהמילים שלכם',
  'describe.estimating': 'מעריכים…',
  'describe.addTo': 'הוספה ל{day}',
  'nutrition.addMeal': 'הוספת ארוחה',
  'nutrition.addMealTo': 'הוספת ארוחה ל{day}',
  'repeat.mode': 'שוב',
  'repeat.nothingYet': 'עוד אין מה לחזור עליו — רשמו כמה ארוחות והן יופיעו כאן.',
  'repeat.seenBefore': 'נרשם {count}× · בדרך כלל {slot}',
  'repeat.unconfirmed': 'המספרים טרם אושרו',
  'repeat.addsTo': 'מוסיף עותק ל{day}. עריכה שלו בהמשך לא תשנה את המקור.',
  'nutrition.modeManual': 'ידני',
  'nutrition.modeDescribe': 'תיאור',
  ...
  'estimate.kcalShort': 'קלוריות',
  'estimate.protShort': 'חלבון',
  'estimate.carbShort': 'פחמ׳',
  'estimate.fatShort': 'שומן',
  'editor.refilledBy': 'מילוי {taps}× · ‎+{percent}%',
  'editor.saveWithTotal': 'שמירה · {kcal}',
  'leftover.prompt': 'נשארה שארית בצלחת?',
  'leftover.saveFirst': 'שמרו או בטלו את השינויים קודם — שארית נמדדת מול הארוחה כפי שנשמרה.',
  'leftover.open': 'רישום שארית',
  'leftover.openTitle': 'שארית — הקטנת הארוחה לפי מה שלא נאכל',
  'leftover.whatsLeft': 'מה נשאר מהארוחה כולה?',
  'leftover.photoPrompt': 'תמונה של מה שנשאר בצלחת',
  'leftover.describePrompt': 'כל הביצה נאכלה אבל רק חצי מהלחם',
  'leftover.estimate': 'הערכת השארית',
  'leftover.share': 'בערך {percent}% מהארוחה נאכלו',
  'leftover.willScale':
    'כל מזון יוקטן לפי החלק שנאכל — נשמר כמספרים חדשים, לא כהערה. הם הגיעו מהמודל, ולכן דורשים אישור.',
  'leftover.nothingLeft': 'שום דבר לא חזר — הארוחה לא השתנתה.',
  'leftover.apply': 'החלה על הארוחה',
  'leftover.again': 'ניסיון נוסף',
  'editor.refill': 'מילוי',
  ...
  'gaps.estimatedDayNote':
    'לא נרשם כלום, אז אלה ערכי היום הממוצע שלכם. רשמו כאן ארוחה והיא תחליף את ההערכה.',
